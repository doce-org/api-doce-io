...
const create_view_last_records_per_hardwares = fs.readFileSync(
	`${__dirname}/../sql/${sql_folder}/views/create_view_last_records_per_hardwares.sql` ).toString();
...
exports.up = function( knex, Promise ) {
    ...
    return Promise.all( [
        ...
        knex.schema.raw( create_view_last_records_per_hardwares ),
...
exports.down = function( knex, Promise ) {
    ...
    return Promise.all( [
        ...
        knex.schema.raw( 'DROP VIEW IF EXISTS last_records_per_hardwares;' ),
